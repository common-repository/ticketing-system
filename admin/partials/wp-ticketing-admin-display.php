 ...
 * @subpackage Wp_ticketing/admin/partials
 */
...
$username = !empty($allOptions['wpticketing-email']) ? $allOptions['wpticketing-email'] : '';
$password = !empty($allOptions['wpticketing-password']) ? $allOptions['wpticketing-password'] : '';
?>
<?php
...
<div class="wrap">
    <h2>Configuración de acceso a sus ticketing</h2>
    <div><br><br><a style="padding: 10px; background-color: #0095ff; color: #fff; text-decoration: none; border-radius: 3px; font-size: 20px;" href="admin.php?page=ticketing-online%2Fticketing-online-admin-page.php">Para empezar a utilizar el plugin haga click aquí</a><br><br></div>
